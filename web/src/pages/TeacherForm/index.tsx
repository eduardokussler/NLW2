      ...
      <main>
        <form onSubmit={handleCreateClass}>
          ...
          <fieldset>
            ...
            <Select name="subject" label="Matéria" value={subject} onChange={(e) => {
            ...
            <Input name="cost" value={cost} onChange={(e) => {
              ...
              scheduleItems.map((scheduleItem, index) => {
                return (
                  <div key={scheduleItem.week_day} className="schedule-item">
                    <Select name="week_day" value={scheduleItem.week_day} onChange={e => {
                    ...
                    <Input name="from" value={scheduleItem.from} onChange={e => {
                      setScheduleItemValue(index, 'from', e.target.value);
                    }} label="Das" type="time"/>
                    <Input name="to" value={scheduleItem.to} onChange={e => {
